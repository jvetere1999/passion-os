...
export const metadata: Metadata = {
  title: "Drum Patterns",
  description: "Rhythm and percussion templates for music production.",
};

export default function DrumTemplatesPage() {
  const templates = getTemplatesByCategory("drums");
  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <h1 className={styles.title}>Drum Patterns</h1>
        <p className={styles.subtitle}>
          {templates.length} rhythm and percussion templates
        </p>
      </header>
