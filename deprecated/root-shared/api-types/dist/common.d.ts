 ...
 */
export type ApiErrorType = 'not_found' | 'unauthorized' | 'forbidden' | 'csrf_violation' | 'invalid_origin' | 'bad_request' | 'validation_error' | 'oauth_error' | 'session_expired' | 'database_error' | 'internal_error' | 'config_error';
/**
