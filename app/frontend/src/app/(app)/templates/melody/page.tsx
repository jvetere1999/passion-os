...
export const metadata: Metadata = {
  title: "Melodies",
  description: "Lead and melodic templates for music production.",
};

export default function MelodyTemplatesPage() {
  const templates = getTemplatesByCategory("melody");
  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <h1 className={styles.title}>Melodies</h1>
        <p className={styles.subtitle}>
          {templates.length} lead and melodic templates
        </p>
      </header>
